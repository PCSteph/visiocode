...
<?PHP echo "<body";
if ($_SESSION['autorisation']) echo " onLoad=\"chargement('".$_SESSION['page_actuel']."');\"";
echo ">"; ?>
    ...
    <div class="Main">
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        <li><a href="accueil.php"><span><span>Accueil</span></span></a></li>
                            ...
                            <div class="Block-body">
                                ...
                                <div class="BlockContent">
                                    <div class="BlockContent-body">
                                        ...
                                        <div align="center"><a href="#" onclick="chg_contenu('./forminscription.php','principal');">S'inscrire</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
