  ...
  <div class="Post-body">
    <div class="Post-inner">
      <h2 class="PostHeaderIcon-wrapper">
        <span class="PostHeader">Salle de leçons de code classiques</span>
      </h2>
...
//						SELECT nserie,min(nquestion) from question where nserie not in (select nserie from histo where histo.id_login='".$_SESSION['id_login']."') group by nserie limit 0,20;");
                        ...
                        {
                            echo "<li onclick=\"\"><a onclick=\"window.open('client/classique/form_visu.php?nserie=".$data['nserie']."&nquestion=1','','menubar=no, status=no, scrollbars=no, menubar=no');\">";
